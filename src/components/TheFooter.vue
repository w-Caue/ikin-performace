  ...
  >
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
      <div class="sm:col-span-2 flex flex-col justify-start">
        ...
        >
          <img class="w-16" src="../assets/logo-ikin.png" alt="logo itim" />
        </a>
      </div>
      <div class="space-y-2 font-bold">
        ...
        <div class="flex text-sm">
          ...
          <a
            href="mailto:ikinperformace@gmail.com"
            aria-label="Our email"
            title="Our email"
            class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"
            >ikinperformace@gmail.com</a
          >
        </div>
      </div>
      <div>
    ...
    >
      <p class="text-sm text-gray-600 font-bold">
        © Copyright 2025 Code Set7. Todos os direitos reservados.
      </p>
      <ul
